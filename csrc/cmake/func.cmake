...
function(add_bin_compile_target)
    ...
    foreach(bin_script ${compile_scripts})
        ...
        if (_compile_flag)
            ...
            if(DEFINED ENV{OPS_OVERLAP_OPC_SOC_VERSION} AND NOT "$ENV{OPS_OVERLAP_OPC_SOC_VERSION}" STREQUAL "")
                list(APPEND _BUILD_COMMAND sed -i -E "s/--soc_version=[^[:space:]]+/--soc_version=$ENV{OPS_OVERLAP_OPC_SOC_VERSION}/g" ${bin_script} &&)
            endif()
