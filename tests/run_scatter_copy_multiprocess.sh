...
if [[ "${SCATTER_PREVIEW}" != 1 ]]; then
  ...
  export ASCEND_CUSTOM_OPP_PATH="${SCATTER_ROOT}/_custom_opp_bf16/vendors/customize"
  export NANOVLLM_A5_INSTALL_OPP_PATH="${SCATTER_ROOT}/_custom_opp_bf16"
  export NANOVLLM_CUST_OPAPI_LIB="${SCATTER_ROOT}/_custom_opp_bf16/vendors/customize/op_api/lib/libcust_opapi.so"
